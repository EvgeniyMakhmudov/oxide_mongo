...
use mongodb::bson::{self, Bson, DateTime, Decimal128, Document, doc, oid::ObjectId};
...
impl ValueEditKind {
    ...
    fn parse(self, input: &str) -> Result<Bson, String> {
        ...
        match self {
            ...
            Self::Document => {
                let bson = shell::parse_shell_bson_value(input)?;
                match bson {
            ...
            Self::Other => shell::parse_shell_bson_value(input)
