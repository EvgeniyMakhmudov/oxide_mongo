...
pub(crate) fn german_map() -> &'static HashMap<&'static str, &'static str> {
    ...
    MAP.get_or_init(|| {
        HashMap::from([
            ...
            ("Move Tab Left", "Tab nach links verschieben"),
            ("Move Tab Right", "Tab nach rechts verschieben"),
            ("Open window maximized on startup", "Fenster beim Start maximiert öffnen"),
            ("Tab Color", "Tab-Farbe"),
