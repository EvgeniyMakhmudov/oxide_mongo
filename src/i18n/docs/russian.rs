...
"#,
            ...
            (
                ...
                DocSection {
                    ...
                    markdown: r#"# Горячие клавиши

- F2 — переключить результаты в режим таблицы
- F4 — переключить результаты в режим текста
- F5 — выполнить запрос активной вкладки
- Alt+←/Alt+→ — переместить активную вкладку влево или вправо
