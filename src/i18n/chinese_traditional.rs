...
pub(crate) fn chinese_traditional_map() -> &'static HashMap<&'static str, &'static str> {
    ...
    MAP.get_or_init(|| {
        HashMap::from([
            ...
            ("Copy JSON", "複製 JSON"),
            ("Duplicate Tab", "複製分頁"),
            ("Move Tab Left", "向左移動分頁"),
            ("Move Tab Right", "向右移動分頁"),
            ("Open window maximized on startup", "啟動時最大化視窗"),
            ("Tab Color", "分頁顏色"),
            ...
            ("Require typing names to confirm database/collection/index deletion", "刪除資料庫/集合/索引時需輸入名稱確認"),
            ("Enable logging", "啟用日誌"),
            ("Log level", "日誌等級"),
            ("Log file path", "日誌檔路徑"),
            ("Path", "路徑"),
